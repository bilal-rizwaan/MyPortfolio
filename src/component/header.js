...
export default function header() {
    ...
    return ( < div >
        ...
        to = "/" > < span > B < /span> - Folio < /Link > < button className = "navbar-toggler"
        type = "button" > <
        ...
        <
        li className = "nav-item download_cv" > < a className = "nav-link"
        href = { pdfile }
        download > Resume < i className = "fal fa-download" > < /i>< /a > < /li >
